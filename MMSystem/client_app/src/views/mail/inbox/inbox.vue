              ...
              <div class="w-8/12 ml-2">
                ...
                <div class="min-h-64 text-sm bg-gray-100">
                  <div v-for="mail in inboxMails" :key="mail.mail_id" :class="mail.flag | mail_state_inbox" class="
                        ...
                        pl-2
                      ">
                    <button class="w-11/12 flex items-center  "
                    ...
                    <div class="w-1/12 flex justify-between items-center">
                      <div  v-if=" (mail.resendfrom == 0 && isperent!='true') || isperent == 'true' " class="w-1/3 flex justify-center items-center">
                      ...
                      <div  v-else class="w-1/3 flex justify-center items-center">
                        <router-link title="عرض التفصيل" :to="{
                          name: 'inbox-show',
                          params: {
                      ...
                      <div  v-if=" (mail.resendfrom == 0 && isperent!='true') || isperent == 'true' "   
                      
                        class="w-1/3 flex justify-center items-center">
                        <button v-if="roles.includes('s')" @click="GetAllDocuments(mail.mail_id, 1, mail.mangment_sender_id)" title="عرض المستندات"
...
//************************************end 1/3/2023 addreply
   ...
   this.$http.mailService
    ...
    GetAllDocuments(id, plase,department_id) {
      this.from_reply_or_general = plase;
      this.screenFreeze = true;
      this.loading = true;
      this.$http.mailService
